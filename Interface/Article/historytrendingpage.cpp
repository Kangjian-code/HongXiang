...
#include "ui_historytrendingpage.h"

HistoryTrendingPage::HistoryTrendingPage(QWidget *parent) :
	QWidget(parent),
	ui(new Ui::HistoryTrendingPage)
{
...
void HistoryTrendingPage::initTreeView()
{
...
void HistoryTrendingPage::initLeftTabs()
{
...
void HistoryTrendingPage::initCharts()
{
...
HistoryTrendingPage::~HistoryTrendingPage()
{

}

void HistoryTrendingPage::hideLeft()
{
	//显示
