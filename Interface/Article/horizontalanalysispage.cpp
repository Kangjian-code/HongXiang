...
#include "ui_horizontalanalysispage.h"

HorizontalAnalysisPage::HorizontalAnalysisPage(QWidget *parent) :
	QWidget(parent),
	ui(new Ui::HorizontalAnalysisPage)
{
...
void HorizontalAnalysisPage::initTreeView()
{
...
void HorizontalAnalysisPage::initLeftTabs()
{
...
void HorizontalAnalysisPage::initChart()
{
...
void HorizontalAnalysisPage::hideLeft()
{
	//显示
...
HorizontalAnalysisPage::~HorizontalAnalysisPage()
{
	delete ui;
}
