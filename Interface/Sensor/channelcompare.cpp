#include "channelcompare.h"
#include "ui_channelcompare.h"

ChannelCompare::ChannelCompare(QWidget *parent) :
	QWidget(parent),
	ui(new Ui::ChannelCompare)
{
	ui->setupUi(this);
...
void ChannelCompare::checkBoxClicked(bool b)
{
	if(b){
		qDebug()<<"打开所有的复选框";
...
void ChannelCompare::updateTable()
{
