#include "eventdesc.h"
#include "ui_eventdesc.h"

eventDesc::eventDesc(QWidget *parent) :
	QWidget(parent),
	ui(new Ui::eventDesc)
{
	ui->setupUi(this);
...
void eventDesc::checkBoxClicked(bool b)
{
	if(b){
		qDebug()<<"打开所有的复选框";
