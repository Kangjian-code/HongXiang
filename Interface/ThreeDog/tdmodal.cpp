...
void TDModal::initInterface(QString title)
{
    ...
    m_pTitleWidget->resize(this->width(),56);
    m_pTitleWidget->setFixedHeight(56);
...
//    m_pCloseBtn->setCallback(this,my_selector(close));
    ...
    connect(m_pCancleBtn,SIGNAL(clicked(bool)),this,SLOT(close()));
...
void TDModal::setButtonText(const QString &rightText, const QString &leftText)
{
